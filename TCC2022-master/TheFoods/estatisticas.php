    ...
    // Create the data table.
      var data = google.visualization.arrayToDataTable([
        ...
        <?php }
            ...
            $mcal = $tcal/$i;
        ?>
        ['Carboidratos',<?php echo $tcarb ?>, 'color: #FFA07A'],
        ['Proteinas',<?php echo $tprot ?>, 'color: #FA8072'],
        ['Gorduras',<?php echo $tgod ?>, 'color: #DC143C'],
        ['Calorias',<?php echo $tcal ?>, 'color: #8B0000'],
         
      ]);
      

// Set chart options
var options = {'title':'TOTAL DE MACRONUTRIENTES INGERIDOS NO MES',
               'width':1180,
               'height':600,
               };
...
<div class="mt-5">
    <form method="post">
    <div><input type="submit" value="Voltar" name="boto" id="boto" class="botao"></div>
    <br>
    <div class="ml-2"><input type="submit" value="Proximo" name="boto2" id="boto2" class="botao "></div>
    </form>
</div>
    ...
    <?php
        ...
        if (isset($_POST["boto2"])){
            header('Location:estatisticas2.php');    
    }
    ?>
    <div class="container">
    <div class="col-md-6">
